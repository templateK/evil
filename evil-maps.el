...
(define-key evil-normal-state-map "e" 'evil-change)
(define-key evil-normal-state-map "E" 'evil-change-line)
(define-key evil-normal-state-map "o" 'evil-delete)
(define-key evil-normal-state-map "O" 'evil-delete-line)
...
(define-key evil-normal-state-map "D" 'evil-join)
(define-key evil-normal-state-map "_" 'evil-set-marker)
(define-key evil-normal-state-map (kbd "RET") 'evil-open-below)
(define-key evil-normal-state-map (kbd "S-<return>") 'evil-open-above)
(define-key evil-normal-state-map "F" 'evil-paste-after)
(define-key evil-normal-state-map "f" 'evil-paste-before)
(define-key evil-normal-state-map "u" 'evil-record-macro)
(define-key evil-normal-state-map "U" 'evil-execute-last-recorded-macro)
(define-key evil-normal-state-map "j" 'evil-replace)
(define-key evil-normal-state-map "J" 'evil-enter-replace-state)
;; (define-key evil-normal-state-map "s" 'evil-substitute)
;; (define-key evil-normal-state-map "S" 'evil-change-whole-line)
(define-key evil-normal-state-map "," 'evil-delete-char)
(define-key evil-normal-state-map ":" 'evil-delete-backward-char)
...
(define-key evil-normal-state-map "y#" 'evil-ex-repeat-global-substitute)
;; (define-key evil-normal-state-map "g8" 'what-cursor-position)
;; (define-key evil-normal-state-map "ga" 'what-cursor-position)
(define-key evil-normal-state-map "yt" 'evil-insert-resume)
;; (define-key evil-normal-state-map "gI" 'evil-insert-0-line)
;; (define-key evil-normal-state-map "gJ" 'evil-join-whitespace)
(define-key evil-normal-state-map "yP" 'evil-paste-after-cursor-after)
(define-key evil-normal-state-map "yp" 'evil-paste-before-cursor-after)
...
(define-key evil-normal-state-map "y~" 'evil-invert-case)
...
(define-key evil-normal-state-map "\C-c" 'evil-paste-pop-next)
(define-key evil-normal-state-map "\C-f" 'evil-paste-pop)
;; (define-key evil-normal-state-map "\C-t" 'pop-tag-mark)
(define-key evil-normal-state-map (kbd "C-p") 'evil-repeat-pop)
(define-key evil-normal-state-map (kbd "C-g") 'evil-repeat-pop-next)
(define-key evil-normal-state-map "x" 'evil-repeat)
...
;; go to last change
(define-key evil-normal-state-map "yc" 'evil-goto-last-change)
(define-key evil-normal-state-map "yf" 'evil-goto-last-change-reverse)

;; undo
(define-key evil-normal-state-map "c" 'evil-undo)
(define-key evil-normal-state-map "C" 'evil-redo)
...
(define-key evil-motion-state-map "w" 'evil-beginning-of-line)
...
(define-key evil-motion-state-map "M" 'evil-forward-WORD-end)
(define-key evil-motion-state-map "v" 'evil-find-char)
(define-key evil-motion-state-map "V" 'evil-find-char-backward)
(define-key evil-motion-state-map "Y" 'evil-goto-line)
(define-key evil-motion-state-map "p" 'evil-backward-char)
...
(define-key evil-motion-state-map "I" 'evil-search-previous)
(define-key evil-motion-state-map "b" 'evil-find-char-to)
(define-key evil-motion-state-map "B" 'evil-find-char-to-backward)
(define-key evil-motion-state-map "s" 'evil-forward-word-begin)
(define-key evil-motion-state-map "S" 'evil-forward-WORD-begin)
(define-key evil-motion-state-map "l" 'evil-yank)
(define-key evil-motion-state-map "L" 'evil-yank-line)
;; (define-key evil-motion-state-map "gd" 'evil-goto-definition)
(define-key evil-motion-state-map "k" 'evil-backward-word-end)
(define-key evil-motion-state-map "K" 'evil-backward-WORD-end)
(define-key evil-motion-state-map "yy" 'evil-goto-first-line)
(define-key evil-motion-state-map "yh" 'evil-next-visual-line)
;; (define-key evil-motion-state-map (vconcat "g" [down]) 'evil-next-visual-line)
(define-key evil-motion-state-map "ys" 'evil-previous-visual-line)
;; (define-key evil-motion-state-map (vconcat "g" [up]) 'evil-previous-visual-line)
(define-key evil-motion-state-map "yw" 'evil-beginning-of-visual-line)
(define-key evil-motion-state-map "G" 'evil-last-non-blank)
(define-key evil-motion-state-map "yP" 'evil-first-non-blank-of-visual-line)
...
(define-key evil-motion-state-map "yG" 'evil-end-of-visual-line)
...
(define-key evil-motion-state-map "#^" 'evil-search-unbounded-word-backward)
(define-key evil-motion-state-map "W" 'evil-end-of-line)
...
(define-key evil-motion-state-map "#*" 'evil-search-unbounded-word-forward)
(define-key evil-motion-state-map "Q" 'evil-repeat-find-char-reverse)
(define-key evil-motion-state-map "/" 'evil-search-forward)
(define-key evil-motion-state-map "q" 'evil-repeat-find-char)
(define-key evil-motion-state-map "?" 'evil-search-backward)
;; (define-key evil-motion-state-map "|" 'evil-goto-column)
(define-key evil-motion-state-map "P" 'evil-first-non-blank)
...
(define-key evil-motion-state-map (kbd "C-s") 'evil-scroll-line-down)
;; (define-key evil-motion-state-map (kbd "C-f") 'evil-scroll-page-down)
(define-key evil-motion-state-map (kbd "C-o") 'evil-jump-backward)
(define-key evil-motion-state-map (kbd "C-h") 'evil-scroll-line-up)
...
(define-key evil-motion-state-map "r" 'evil-visual-char)
(define-key evil-motion-state-map "d" 'evil-visual-line)
(define-key evil-motion-state-map "z" 'evil-visual-block)
(define-key evil-motion-state-map "yr" 'evil-visual-restore)
...
(define-key evil-motion-state-map "\C-t" 'evil-scroll-column-right)
;; (define-key evil-motion-state-map [?z right] 'evil-scroll-column-right)
(define-key evil-motion-state-map "\C-d" 'evil-scroll-column-left)
;; (define-key evil-motion-state-map [?z left] 'evil-scroll-column-left)
(define-key evil-motion-state-map (kbd "C-S-t") 'evil-scroll-end-column)
(define-key evil-motion-state-map (kbd "C-S-d") 'evil-scroll-start-column)
...
(define-key evil-outer-text-objects-map "d" 'evil-a-single-quote)
(define-key evil-outer-text-objects-map "m" 'evil-a-back-quote)
...
(define-key evil-outer-text-objects-map "c" 'evil-a-tag)
(define-key evil-outer-text-objects-map "l" 'evil-a-symbol)
(define-key evil-outer-text-objects-map (kbd "<SPC>") 'evil-a-symbol)
...
(define-key evil-inner-text-objects-map "e" 'evil-inner-double-quote)
(define-key evil-inner-text-objects-map "o" 'evil-inner-single-quote)
(define-key evil-inner-text-objects-map "," 'evil-inner-back-quote)
(define-key evil-inner-text-objects-map "n" 'evil-inner-bracket)
(define-key evil-inner-text-objects-map "y" 'evil-inner-angle)
(define-key evil-inner-text-objects-map "i" 'evil-inner-paren)
(define-key evil-inner-text-objects-map "(" 'evil-inner-paren)
(define-key evil-inner-text-objects-map ")" 'evil-inner-paren)
(define-key evil-inner-text-objects-map "[" 'evil-inner-bracket)
(define-key evil-inner-text-objects-map "]" 'evil-inner-bracket)
(define-key evil-inner-text-objects-map "a" 'evil-inner-curly)
...
(define-key evil-inner-text-objects-map (kbd "<SPC>") 'evil-inner-symbol)
(define-key evil-motion-state-map "yp" 'evil-next-match)
(define-key evil-motion-state-map "yg" 'evil-previous-match)

;; (when evil-want-C-i-jump
(define-key evil-motion-state-map (kbd "C-e") 'evil-jump-forward)

;; (when evil-want-C-u-scroll
(define-key evil-motion-state-map (kbd "<C-i>") 'evil-scroll-up)

;; (when evil-want-C-d-scroll
(define-key evil-motion-state-map (kbd "C-n") 'evil-scroll-down)
...
(define-key evil-visual-state-map "_" 'evil-beginning-of-line)
(define-key evil-visual-state-map "c" 'evil-yank)
(define-key evil-visual-state-map "," 'evil-visual-paste)
(define-key evil-visual-state-map "A" 'evil-append)
(define-key evil-visual-state-map "T" 'evil-insert)
(define-key evil-visual-state-map (kbd "RET") 'exchange-point-and-mark)
(define-key evil-visual-state-map (kbd "S-<return>") 'evil-visual-exchange-corners)
...
(define-key evil-visual-state-map "t" evil-inner-text-objects-map)
...
(define-key evil-operator-state-map "t" evil-inner-text-objects-map)
...
(evil-ex-define-cmd "l" 'evil-window-split)
(evil-ex-define-cmd "t" 'evil-window-vsplit)
